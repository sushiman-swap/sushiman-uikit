...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$n, { width: "24px", color: isDark ? "textSubtle" : "#F04D92" })) : (React__default['default'].createElement(Icon$o, { width: "24px", color: isDark ? "textSubtle" : "#F04D92" }))),
